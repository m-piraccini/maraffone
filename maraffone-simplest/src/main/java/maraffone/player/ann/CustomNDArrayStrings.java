...
public class CustomNDArrayStrings extends NDArrayStrings{
    ...
    public CustomNDArrayStrings(String sep) {
        this(", ",2);
    }

    public CustomNDArrayStrings(int precision) {
        this(", ",precision);
    }
    
    public CustomNDArrayStrings(String sep, int precision) {
        this.sep = sep;
        if (precision != 0) {
            this.decFormatRest = ".";
            while (precision > 0) {
